...
import com.lilyVia.springbootinit.model.dto.user.*;
import com.lilyVia.springbootinit.model.entity.User;
import com.lilyVia.springbootinit.model.vo.LoginUserVO;
...
import static com.lilyVia.springbootinit.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Long> addUser(@RequestParam UserAddRequest userAddRequest, HttpServletRequest request) {
    ...
    @GetMapping("/get")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<User> getUserById(@Min(0L) long id, HttpServletRequest request) {
        // 校验是否登录
     ...
     */
    @GetMapping("/get/vo")
    public BaseResponse<UserVO> getUserVOById(@Min(0L)long id, HttpServletRequest request) {
